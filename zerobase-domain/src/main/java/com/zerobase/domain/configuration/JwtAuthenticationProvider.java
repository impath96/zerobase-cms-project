package com.zerobase.domain.configuration;
...
public class JwtAuthenticationProvider {
    ...
    public String createToken(String userPk, Long id, UserType userType) {
        Claims claims = Jwts.claims().setSubject(Aes256Utils.encrypt(userPk))
    ...
    public UserVo getUserVo(String token) {
        ...
        return new UserVo(Long.valueOf(Aes256Utils.decrypt(claims.getId())),
